...
function setUpBicycle(){
	...
	travelOption[2]=new bike($("#appPayment").val(),$("#appRepair").val(),parseFloat(sessionStorage.getItem('bicycleDist')),parseFloat(sessionStorage.getItem('bicycleDuration')));	
	...
	sessionStorage.setItem("initial","BICYCLE");
