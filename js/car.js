...
function setUpCar(){
	...
	travelOption[1]=new carpool(parseFloat(sessionStorage.getItem('rate')),
		parseFloat($("#appPayment").val()),sessionStorage.getItem('repair'),parseFloat(sessionStorage.getItem('mpg')),$("#daysVisit").val(),sessionStorage.getItem("distCalc"),sessionStorage.getItem("commuteDuration"),2);
	...
	sessionStorage.setItem("initial","CAR");
